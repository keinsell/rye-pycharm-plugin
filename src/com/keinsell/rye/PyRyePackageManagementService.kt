...
class PyRyePackageManagementService(project: Project, sdk: Sdk) : PyPackageManagementService(project, sdk) {
    ...
    override fun getAllPackages(): List<RepoPackage> {
        PyPIPackageUtil.INSTANCE.loadAdditionalPackages(sdk.ryeSources, false)
        return allPackagesCached
    }

    override fun reloadAllPackages(): List<RepoPackage> {
        PyPIPackageUtil.INSTANCE.loadAdditionalPackages(sdk.ryeSources, true)
        return allPackagesCached
    }

    override fun getAllPackagesCached(): List<RepoPackage> =
        PyPIPackageUtil.INSTANCE.getAdditionalPackages(sdk.ryeSources)
